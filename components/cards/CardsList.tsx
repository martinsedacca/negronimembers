...
export default function CardsList({ members }: CardsListProps) {
  ...
  const getMembershipColor = () => {
    return 'from-black to-gray-900' // Negro para todas
  }
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="pt-4 space-y-2">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition font-medium text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  >
