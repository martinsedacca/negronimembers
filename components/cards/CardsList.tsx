      ...
      <div className="bg-neutral-800 border border-neutral-700 shadow rounded-lg p-6">
        <div className="relative">
          ...
          <input
            ...
            className="pl-10 w-full px-4 py-3 bg-neutral-700 border border-neutral-600 text-white rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-neutral-400"
          />
        </div>
      </div>
