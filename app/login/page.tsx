        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-gray-700 border border-gray-600 text-white rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition placeholder-gray-400"
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="flex-1 bg-gray-700 text-gray-200 py-3 px-4 rounded-lg font-medium hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-600/50 disabled:opacity-50 disabled:cursor-not-allowed transition"
            >
              Registrarse
            </button>
          </div>
